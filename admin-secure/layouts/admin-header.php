        ...
        <nav class="sidebar-nav">
            <ul class="nav-list">
                <li class="nav-item <?php echo $currentPage === 'dashboard' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-dashboard" class="nav-link" data-tooltip="Dashboard">
                ...
                <li class="nav-item <?php echo $currentPage === 'users' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-users" class="nav-link" data-tooltip="Users">
                ...
                <li class="nav-item <?php echo $currentPage === 'security' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-security" class="nav-link" data-tooltip="Security Center">
                ...
                <li class="nav-item <?php echo $currentPage === 'monitoring' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-monitoring" class="nav-link" data-tooltip="System Monitor">
                ...
                <li class="nav-section">Content & Users</li>

                <li class="nav-item <?php echo $currentPage === 'content' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-content" class="nav-link" data-tooltip="Moderation">
                ...
                <li class="nav-item <?php echo $currentPage === 'learning' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-learning" class="nav-link" data-tooltip="Learning Center">
                ...
                <li class="nav-item <?php echo $currentPage === 'notifications' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-notifications" class="nav-link" data-tooltip="Notifications">
                        <span class="material-icons nav-icon">notifications</span>
                        <span class="nav-text">Notifications</span>
                        <?php if ($unreadNotifications > 0): ?>
                            <span class="nav-badge warning"><?php echo min($unreadNotifications, 99); ?></span>
                        <?php endif; ?>
                    </a>
                </li>

                <li class="nav-section">AI Management</li>

                <li class="nav-item <?php echo $currentPage === 'ai' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-ai" class="nav-link" data-tooltip="AI Settings">
                ...
                <li class="nav-item <?php echo $currentPage === 'analytics' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-analytics" class="nav-link" data-tooltip="Analytics">
                ...
                <li class="nav-item <?php echo $currentPage === 'reports' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-reports" class="nav-link" data-tooltip="Reports">
                ...
                <li class="nav-item <?php echo $currentPage === 'backup' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-backup" class="nav-link" data-tooltip="Backup">
                ...
                <li class="nav-item <?php echo $currentPage === 'settings' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>?page=admin-settings" class="nav-link" data-tooltip="Settings">
                ...
                <li class="nav-item <?php echo $currentPage === 'shop-settings' ? 'active' : ''; ?>">
                    <a href="<?php echo $base_url; ?>admin-secure/pages/admin-shop-settings.php" class="nav-link" data-tooltip="Shop Settings">
        ...
        <header class="admin-header">
            <div class="header-left">
                ...
                <div class="breadcrumb">
                    <a href="<?php echo $base_url; ?>?page=admin-dashboard">Admin</a>
                    <span class="material-icons">chevron_right</span>
                    <span class="current"><?php echo htmlspecialchars($currPage ?? 'Dashboard'); ?></span>
                </div>
            </div>
            ...
            <div class="header-right">
                ...
                <div class="notification-dropdown">
                    ...
                    <div class="dropdown-menu notification-menu" id="notificationMenu">
                        ...
                        <div class="dropdown-footer">
                            <a href="<?php echo $base_url; ?>?page=admin-notifications">View all notifications</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-menu user-menu" id="userMenu">
                        ...
                        <a href="<?php echo $base_url; ?>?page=admin-settings&section=profile" class="dropdown-item">
                            <span class="material-icons">person</span>
                            My Profile
                        </a>
                        <a href="<?php echo $base_url; ?>?page=admin-settings" class="dropdown-item">
    ...
    <div class="search-overlay" id="searchOverlay">
        <div class="search-modal">
            <div class="search-input-wrap">
                ...
                <input type="text" id="searchModalInput" placeholder="Search users, pages, settings…" autocomplete="off">
                <kbd>Esc</kbd>
            </div>
            <div class="search-results" id="searchResults">
                <div class="search-section-label">Quick Navigation</div>
                <?php
                $quickLinks = [
                    ['admin-dashboard','dashboard','Dashboard','Admin overview & stats'],
                    ['admin-users','people','Users','Manage all users'],
                    ['admin-security','security','Security Center','Threats & IP rules'],
                    ['admin-monitoring','monitor_heart','System Monitor','Server & DB health'],
                    ['admin-analytics','analytics','Analytics','Usage analytics'],
                    ['admin-reports','description','Reports','Generate & export reports'],
                    ['admin-ai','smart_toy','AI Settings','Providers & models'],
                    ['admin-notifications','notifications','Notifications','Send broadcasts'],
                    ['admin-backup','backup','Backup','Database backups'],
                    ['admin-settings','settings','Settings','System configuration'],
                    ['admin-content','report','Moderation','Content reports'],
                    ['admin-learning','school','Learning Center','Manage content'],
                ];
                foreach ($quickLinks as [$route, $icon, $title, $sub]):
                ?>
                <a href="<?php echo $base_url; ?>?page=<?php echo $route; ?>" class="search-result-item" data-search="<?php echo strtolower($title . ' ' . $sub); ?>">
                    <div class="search-result-icon"><span class="material-icons"><?php echo $icon; ?></span></div>
                    <div class="search-result-text">
                        <div class="search-result-title"><?php echo $title; ?></div>
                        <div class="search-result-sub"><?php echo $sub; ?></div>
                    </div>
                </a>
                <?php endforeach; ?>
            </div>
