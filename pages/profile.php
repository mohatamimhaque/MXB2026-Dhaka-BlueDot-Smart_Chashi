...
<section class="hero-modern">
    ...
    <div class="hero-content">
        ...
        <h1>
            <span class="material-icons" style="font-size: 2rem;">account_circle</span>
            <?php echo __('your_profile'); ?>
        </h1>
        <p class="hero-subtitle"><?php echo __('manage_account'); ?></p>
    </div>
...
<div class="profile-page-grid">
        ...
        <div class="card profile-card">
            ...
            <div class="profile-actions-grid">
                ...
                <a href="<?php echo $base_url; ?>schedule" class="btn btn-small btn-info"><span class="material-icons" style="font-size: 16px; vertical-align: middle;">event_note</span> Manage Schedule</a>
