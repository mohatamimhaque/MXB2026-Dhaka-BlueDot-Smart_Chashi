...
$farmer = $db->single("SELECT * FROM users WHERE user_id = ? AND role = 'farmer'", [$farmerId]);
    ...
    <div class="profile-view-left">
        ...
        <div class="card profile-view-card">
            <div class="profile-view-header">
                ...
                <div class="profile-view-info">
                    ...
                    <p class="profile-view-role">
                        ...
                        Farmer
                        <?php if (!empty($farmer['experience_level'])): ?>
            ...
            <div class="profile-actions">
                ...
                <a href="<?php echo $base_url; ?>alerts?farmer_id=<?php echo $farmerId; ?>" class="btn btn-info">
                    <span class="material-icons">notifications</span> Visit Alerts
                </a>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="card profile-view-card">
            ...
            <div class="profile-stats-grid">
                <div class="stat-box">
                    <span class="material-icons text-primary">agriculture</span>
                    <div class="stat-value"><?php echo $cropCount; ?></div>
                    <div class="stat-label">Total Crops</div>
                </div>
                <div class="stat-box">
                    <span class="material-icons text-success">eco</span>
                ...
                <div class="stat-box">
                    <span class="material-icons text-info">forum</span>
                ...
                <div class="stat-box">
                    <span class="material-icons text-secondary">storefront</span>
            ...
            <div class="seller-stats-display">
                <div class="seller-rating-big">
                    ...
                    <div class="rating-circle">
                        <span class="rating-number"><?php echo $rating > 0 ? format_number($rating, 1) : 'N/A'; ?></span>
    ...
    <div class="products-mini-grid">
        ...
        <div class="product-mini-card" onclick="window.location.href='<?php echo $base_url; ?>marketplace?product=<?php echo $product['product_id']; ?>'">
            ...
            <div class="product-info">
                ...
                <p class="product-price">৳<?php echo format_number($product['price'], 2); ?></p>
...
/* Text color utilities for stat icons */
.stat-icon.text-primary { color: #557A46; }
.stat-icon.text-success { color: #28a745; }
.stat-icon.text-warning { color: #ffc107; }
.stat-icon.text-info { color: #17a2b8; }
.stat-icon.text-danger { color: #dc3545; }
.stat-icon.text-secondary { color: #6c757d; }
